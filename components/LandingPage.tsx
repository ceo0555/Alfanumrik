...
import { SparklesIcon, MailIcon, PhoneIcon, MapPinIcon, TwitterIcon, LinkedInIcon, FacebookIcon, LockIcon, FileTextIcon, CheckCircleIcon } from '../constants/icons';
import {
            ...
            <main>
                <section id="home" className="relative py-20 md:py-32 text-center bg-slate-50 overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 relative">
                        <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 leading-tight animate-slide-in-up">The Cognitive Operating System for Modern Education.</h1>
                        <p className="mt-6 max-w-3xl mx-auto text-lg text-slate-600 animate-slide-in-up-hero">We leverage proprietary deep learning models and proven cognitive science frameworks—like Bayesian Knowledge Tracing and FSRS—to engineer a hyper-personalized learning ecosystem. We're moving beyond rote memorization to build true, lasting cognitive mastery.</p>
                ...
                <section id="about" className="py-20 bg-white">
                    <div className="container mx-auto px-6 max-w-4xl text-center">
                        <div className="reveal">
                            <h2 className="text-3xl md:text-4xl font-bold">Our Mission: Deconstructing the Factory Model of Education.</h2>
                ...
                <section id="research" className="py-20 bg-slate-50">
                    <div className="container mx-auto px-6">
                        <div className="text-center mb-12 reveal"><h2 className="text-3xl md:text-4xl font-bold">Grounded in Learning Science</h2><p className="mt-2 text-slate-600 max-w-2xl mx-auto">Our platform isn't just technology; it's applied pedagogy. We build upon established, peer-reviewed research in cognitive science and education.</p></div>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <a href="#" onClick={(e) => e.preventDefault()} className="block p-6 bg-white rounded-xl shadow-sm border research-card reveal" style={{transitionDelay: '100ms'}}><h3 className="font-bold text-indigo-600">Bayesian Knowledge Tracing (BKT)</h3><p className="text-sm text-slate-600 mt-2">At the core of our adaptive engine is a dynamic probabilistic model that infers a student's knowledge state for every concept. It goes beyond simple right/wrong scoring to estimate the probability that a student has truly mastered a skill, allowing for precise, just-in-time interventions.</p></a>
                            ...
                            <a href="#" onClick={(e) => e.preventDefault()} className="block p-6 bg-white rounded-xl shadow-sm border research-card reveal" style={{transitionDelay: '500ms'}}><h3 className="font-bold text-indigo-600">Generative Models in Pedagogy</h3><p className="text-sm text-slate-600 mt-2">We utilize fine-tuned Large Language Models, including Google's Gemini, not just for content, but as pedagogical tools. They power our Socratic dialogue engine, generate nuanced feedback, and create diverse assessment items, applying proven teaching strategies at an unprecedented scale.</p></a>
                        </div>
                    </div>
                </section>
