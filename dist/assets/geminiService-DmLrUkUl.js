...
`),o=`
        ...
        Content:
        ${s}
    `,a=await n.models.generateContent({model:"gemini-2.5-flash",contents:o,config:{responseMimeType:"application/json",responseSchema:{type:e.ARRAY,items:{type:e.OBJECT,properties:{term:{type:e.STRING},definition:{type:e.STRING}},required:["term","definition"]}}}});return h(u(a))},Y=async(t,n,s,o,a)=>{l();const r=d(),c=`
    ...
    `,i=await r.models.generateContent({model:"gemini-2.5-flash",contents:c,config:{responseMimeType:"application/json",responseSchema:N}});return h(u(i))},M=async t=>{l();const n=d(),s=`
        ...
        Text to explain: "${t}"
    `,o=await n.models.generateContent({model:"gemini-2.5-flash",contents:s});return u(o)},D=async t=>{l();const n=d(),s=`
        ...
        **Text to explain**: "${t}"
    `,o=await n.models.generateContent({model:"gemini-2.5-pro",contents:s,config:{thinkingConfig:{thinkingBudget:32768}}});return u(o)},U=async(t,n,s)=>{l();const o=d(),a=`
    ...
    `,r=await o.models.generateContent({model:"gemini-2.5-flash",contents:a,config:{responseMimeType:"application/json",responseSchema:{type:e.OBJECT,properties:{isCorrect:{type:e.BOOLEAN},feedback:{type:e.STRING}},required:["isCorrect","feedback"]}}});return h(u(r))},P=async(t,n)=>{l();const s=d(),o=`
    ...
    `,a=await s.models.generateContent({model:"gemini-2.5-flash",contents:o,config:{responseMimeType:"application/json",responseSchema:{type:e.OBJECT,properties:{summary:{type:e.STRING},strengths:{type:e.ARRAY,items:{type:e.STRING}},focusAreas:{type:e.ARRAY,items:{type:e.STRING}},actionableTips:{type:e.ARRAY,items:{type:e.OBJECT,properties:{icon:{type:e.STRING},tip:{type:e.STRING}},required:["icon","tip"]}}},required:["summary","strengths","focusAreas","actionableTips"]}}});return h(u(a))},L=async(t,n)=>{l();const s=d(),{profile:o,dktData:a,assignments:r,submissions:c}=n,i=`
    ...
    `,m=await s.models.generateContent({model:"gemini-2.5-pro",contents:i,config:{thinkingConfig:{thinkingBudget:32768}}});return u(m)},F=async(t,n)=>{l();const s=d(),o=`
    ...
    `,a=await s.models.generateContent({model:"gemini-2.5-flash",contents:o});return u(a)},z=async(t,n,s,o)=>{l();const a=d(),r=`
    ...
    `,y=await i.models.generateContent({model:"gemini-2.5-pro",contents:m,config:{responseMimeType:"application/json",responseSchema:N}});return h(u(y))},X=async t=>{l();const n=d(),s=`
    ...
    `,o=await n.models.generateContent({model:"gemini-2.5-flash",contents:s,config:{responseMimeType:"application/json",responseSchema:{type:e.ARRAY,items:{type:e.OBJECT,properties:{competency:{type:e.STRING},students:{type:e.ARRAY,items:{type:e.STRING}},suggestedTask:{type:e.STRING}},required:["competency","students","suggestedTask"]}}}});return h(u(o))},V=async(t,n)=>{l();const s=d(),o=`
        ...
        Return a raw JSON array of RemediationGroup objects.
    `,a=await s.models.generateContent({model:"gemini-2.5-pro",contents:o,config:{responseMimeType:"application/json",responseSchema:{type:e.ARRAY,items:{type:e.OBJECT,properties:{competency:{type:e.STRING},students:{type:e.ARRAY,items:{type:e.STRING}},suggestedTask:{type:e.STRING}},required:["competency","students","suggestedTask"]}}}});return h(u(a))},Z=async t=>{l();const n=d(),s=`
    ...
    `,o=await n.models.generateContent({model:"gemini-2.5-flash",contents:s});return u(o)},ee=async(t,n)=>{l();const s=d(),o=`
    ...
    `,a=await s.models.generateContent({model:"gemini-2.5-flash",contents:o});return u(a)},te=async(t,n,s,o)=>{l();const a=d(),r=o&&o.length>0?`- The questions must ONLY cover topics from the following chapters: ${o.join(", ")}.`:"- The questions must be relevant to the subject and grade level.",c=`
    ...
    `,i=await a.models.generateContent({model:"gemini-2.5-pro",contents:c,config:{responseMimeType:"application/json",responseSchema:{type:e.ARRAY,items:N}}});return h(u(i))},ne=async t=>{l();const n=d(),s=t.map(r=>({question:r.question.question,isCorrect:r.isCorrect,marksAwarded:r.marksAwarded,totalMarks:r.question.marks})),o=`
    ...
    `,a=await n.models.generateContent({model:"gemini-2.5-flash",contents:o});return u(a)},se=async(t,n)=>{l();const s=d(),o=`
    ...
    `,a=await s.models.generateContent({model:"gemini-2.5-flash",contents:o,config:{responseMimeType:"application/json",responseSchema:{type:e.OBJECT,properties:{title:{type:e.STRING},subject:{type:e.STRING},grade:{type:e.STRING},description:{type:e.STRING},objectives:{type:e.ARRAY,items:{type:e.STRING}},tasks:{type:e.ARRAY,items:{type:e.STRING}}},required:["title","subject","grade","description","objectives","tasks"]}}});return h(u(a))},oe=async(t,n)=>{l();const s=d(),o={inlineData:{mimeType:"image/png",data:t}},a={text:`
    ...
    `},r=await s.models.generateContent({model:"gemini-2.5-pro",contents:{parts:[o,a]}});return u(r)},ae=async(t,n)=>{l();const s=d(),o={inlineData:{mimeType:"image/png",data:t}},a={text:`
        Analyze the student's handwritten work in this image for the question: "${n}".
